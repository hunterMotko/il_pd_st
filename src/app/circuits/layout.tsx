...
import MainTable from "@/components/circuits/MainTable";
import SubTable from "@/components/circuits/SubTable";
...
function Layout(props: any) {
  ...
  useEffect(() => {
    (async () => {
      try {
        let url = `/api/circuits/legend`;
        const l = await getData(url);
        url = `/api/circuits/ids`;
