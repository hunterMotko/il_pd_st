  ...
  return (
    <>
      <div className="grid w-full grid-flow-row gap-x-0 gap-y-1 md:grid-cols-1 md:gap-1 xl:grid-cols-1">
        ...
        <h3 className="text-2xl my-1">HB 5842 – Rep. Dave Vella, Rep. Justin Slaughter, Rep. Kevin Olickal, & Rep. Lilian Jiménez (FAIR) Act</h3>
        <p className="text-lg px-3 mx-3 my-1">
          ...
          <Link
            ...
            className="mt-3 pl-5 text-blue-500 hover:text-purple-900 hover:underline"
          >
      ...
      <section className="max-w-screen-2xl m-auto w-full px-3 sm:px-8 lg:px-16 xl:px-32 flex flex-col gap-12 pb-5 text-center">
        <div className="flex flex-col">
          <h2 className="text-2xl text-purple-900">Learn More</h2>
          <Link
            target="_blank"
            href="https://drive.google.com/file/d/1lHJj2Ej6ZTatXa3HXQ-X-ctQZ4r5ZXWo/view"
            className="pl-5 text-blue-500 hover:text-purple-900 hover:underline"
          >
